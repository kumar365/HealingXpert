...
import com.healthcare.HealingXpert.security.oauth2.CustomOAuth2UserService;
import com.healthcare.HealingXpert.security.oauth2.CustomOidcUserService;
import com.healthcare.HealingXpert.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.healthcare.HealingXpert.security.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
import com.healthcare.HealingXpert.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.healthcare.HealingXpert.security.oauth2.OAuth2AuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().csrf()
				...
				.antMatchers("/", "/error", "/api/all", "/api/auth/**", "login/oauth2/**", "/oauth2/**","/actuator/**", "/common/**","/patient/**")
